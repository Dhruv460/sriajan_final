...
const Timer = () => {
  ...
  return (
    ...
    >
      {showWelcome ? (
        <h1
          className="text-2xl md:text-4xl font-bold text-center mb-6 text-amber-100 hover:text-amber-200 transition-colors duration-300"
          style={{
        ...
        >
          Welcome to Srijan Centenary Spark Celebration!
        </h1>
      ) : (
        <>
          <h1
